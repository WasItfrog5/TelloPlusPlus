...
int main() {
    ...
    while(true) {
        ...
        Sleep(10);//VERY IMPORTANT, PROBLEM WITH PAST EXAMPLES WAS NOT USING "Sleep(any)", WITHOUT THIS IT CAUSES THE DRONE TO RESPOND TO MESSAGES VERY LATE, WHICH CAUSES CRASHES
    }
}